            ...
            if(interaction.values[0] === "System Bot"){
                interaction.reply({
                    embeds: [
                        ...
                        .addField("**Price Overview:**", `> Free Option:**\`8 Invites\`**\n\n> Monthly Option**\`1€ / 30 Days\`**\n\n> Yearly Option: **\`8€ / Year\`**`)
                    ],
                    ephemeral: true
                });
            }
            if(interaction.values[0] === "24/7 Music Bot"){
                interaction.reply({
                    embeds: [
                        new MessageEmbed()
                        .setColor(client.config.color)
                        .setTitle("🔃 Bot Features of: __24/7 MUSIC BOT__ 🔃")
                        .setDescription("> *24/7 Music Bot is an __advance Music Bot__ and can be used 24/7!*\n\n> *It is combined our Music and Waitingroom Bot! With the \`!customsetup [LINK]\` you can setup a 24/7 Playing Playlist for your wished Voice-Channel!*")
                        .addField("**Features Overview:**", `\`\`\`yml\n✅ 24/7 Music\n✅ Instant Fast, cristal Clear Audio-Playback\n✅ Support for Youtube, Spotify, Soundcloud, Apple Music and more!\n✅ Supports Radio Stations\n✅ Stage Channel & Thread Support\n✅ customsetup ... setup custom links for 24/7 Playback\n✅ Can be used as a normal Music Bot!\n✅ Unique Music Request System\n\`\`\``)
                        .addField("**Price Overview:**", `> Free Option:**\`7 Invites\`**\n\n> Monthly Option**\`0.60€ / 30 Days\`**\n\n> Yearly Option: **\`6€ / Year\`**`)
                    ],
                    ephemeral: true
                });
            }

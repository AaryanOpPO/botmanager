...
module.exports = {
    ...
    run: async (client, message, args, prefix) => {
        ...
        return message.reply(`> <a:check:939238439826640957> **The Partner Application System is now: \`${client.setups.get(message.guild.id, "ticketsystem_partnerapply.enabled") ? "Enabled" : "Disabled"}\`**`)
    }
}
...
module.exports = {
    ...
    run: async (client, message, args, prefix) => {
        ...
        return message.reply(`> <a:check:939238439826640957> **The MUSIC BOT ORDER SYSTEM is now: \`${client.setups.get(message.guild.id, "ticketsystem2.enabled") ? "Enabled" : "Disabled"}\`**`)
    }
}
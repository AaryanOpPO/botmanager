...
module.exports = {
    ...
    run: async (client, message, args, prefix) => {
        ...
        .setColor("GREEN")
        .setAuthor("KooJe | Bot Shop | Information Commands Help", message.guild.iconURL({dynamic: true}), "https://kooje.eu")
        ...
        .addField("\`,uptime\`", "*Shows the Uptime of the Bot*", true)
            //.addField("\u200b", "\u200b")
        .addField("\`,howtoorder\`", "*Shows how to order a BOT*\n*See the information in <#936392309065523221> & <#936392558312058880>!*", true)
            //.addField("\u200b", "\u200b")
        ...
        .addField("\`,modifybot\`", "Shows Info how to Change a CUSTOM BOT from <#936392309065523221>*", true)
    ...
    var embed2 = new Discord.MessageEmbed()
        .setColor("YELLOW")
        .setAuthor("KooJe | Bot Shop | STAFF TEAM Help", message.guild.iconURL({dynamic: true}), "https://kooje.eu")
        ...
        .addField("\`,setprotyo\`", "*Sets the Ticket to a Protyo Ticket*", true)
    ...
    var embed3 = new Discord.MessageEmbed()
        .setColor("ORANGE")
        .setAuthor("KooJe | Bot Shop | Higher Staff (Bot Management Commands)", message.guild.iconURL({dynamic: true}), "https://kooje.eu")
    ...
    var embed4 = new Discord.MessageEmbed()
        .setColor("RED")
        .setAuthor("Kooje | Bot Shop | Setup Commands", message.guild.iconURL({dynamic: true}), "https://kooje.eu")
        ...
        .addField("\`,toggleteamapply\`", "*Enables/Disables the Team Apply System*", true)
            //.addField("\u200b", "\u200b")
            //.addField("\u200b", "\u200b")
        .addField("\`,togglesystembot\`", "*Enables/Disables the System Bot Order*", true)
